...
平台面向自学、学校、培训与实验室等多场景，核心采用“学习行为记录 + 自适应 Memory 机制 + 共享知识库 + 教师 Agent 工作流”，通过长周期陪伴、智能复盘和可追踪教学动作，辅助学习者高效成长。

## 视觉与 UI 风格

- 原生级淡色与暗色模式支持。
- 统一侧边栏自适应布局，主仪表盘承载全局导航，子页面保持更聚焦的工作视野。
- 采用克制的蓝色主调、清晰的信息层级和细腻的交互反馈，兼顾学习产品的安静感与 Agent 平台的专业感。
...
- **教学工作台**：班级态势驾驶舱，聚合班级指标、路径趋势、学情洞察、需关注学生、待办队列与教师 Agent 动作面板。
...
- 教师工作台首屏重构为班级态势驾驶舱。
- 教师 Agent 工作台首版：支持生成班级简报、干预计划、分层任务草稿和反馈话术。
- 教师端大量学生选择器。
- 管理端模型配置。
